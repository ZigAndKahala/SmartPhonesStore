...
public class ownerController {
    ...
    public void addemployee(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        databaseAPI.write("INSERT INTO employee " + DatabaseAPI.generateSqlCommand("name,email,password,dateOfBirth,mobileNumber,type",employeeParameters));
    ...
    public void editingEmail(KeyEvent keyEvent) {
        if (!(email.getText().contains("@") && email.getText().contains("."))) {
            if (emailMessage == null)
                emailMessage = MessageLabel.displayTheMessageBesidesTextField(MessageLabel.createLabel("Incorrect Email Address!",1,30),rootPane,email);
    ...
    private void setEmployeesName() throws SQLException, ClassNotFoundException {
        DatabaseAPI databaseAPI = new DatabaseAPI();
